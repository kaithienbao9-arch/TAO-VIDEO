  ...
  const handleStartRender = async () => {
    ...
    try {
      ...
      const runRenderLoop = () => {
        ...
        // Typewriter Sound Simulation during Export
        if (exportConfig.enableHumanTypewriter && subtitles && subtitles.length > 0 && recordCtx && destNode) {
          ...
          if (currentPlaybackTime >= introTime && currentPlaybackTime <= maxAudioEnd) {
            ...
            if (activeBlock) {
              ...
              if (pBlocks.includes(blockNumStr)) {
                ...
                if (typewriterState.blockId !== activeBlock.id) {
                  ...
                  if (charCount > 0) {
                    playTypewriterClick(recordCtx, destNode, exportConfig.typewriterVolume);
                  }
