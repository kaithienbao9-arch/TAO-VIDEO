...
export interface RenderConfig {
  ...
  bgEffect?: 'none' | 'snow' | 'snowflake' | 'rain' | 'sparks' | 'lightning' | 'lightning_clouds' | 'sakura' | 'bubbles' | 'golden_dust' | 'autumn_leaves' | 'starry_glow' | 'hearts' | 'fireflies' | 'matrix_rain' | 'snow_storm' | 'neon_stars' | 'random';
