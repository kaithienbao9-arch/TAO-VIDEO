...
export const DEFAULT_STICKER_GROUPS = [
  {
    id: 'grp_sad_cry',
    name: 'BUỒN & KHÓC',
    keywords: 'sad, cry, crying, tears, sorrow, depressed, painful, upset, khóc, buồn, sầu, đau, khổ',
    size: 280,
    images: []
  },
  {
    id: 'grp_happy_laugh',
    name: 'VUI VẺ & CƯỜI',
    keywords: 'happy, laugh, laughing, smile, smiling, haha, glad, cheerful, joyful, fun, funny, vui, cười, haha, hihi, kiki, sướng',
    size: 280,
    images: []
  },
  {
    id: 'grp_angry',
    name: 'GIẠN DỮ & PHẪN NỘ',
    keywords: 'angry, anger, mad, furious, hate, annoyed, irritate, trigger, giận, cáu, tức, điên, phẫn nộ, khùng',
    size: 280,
    images: []
  },
  {
    id: 'grp_surprised',
    name: 'BẤT NGỜ & KINH NGẠC',
    keywords: 'shock, shocked, surprise, surprised, wow, amazing, unbelievable, wonder, kinh ngạc, bất ngờ, hốt hoảng, ngạc nhiên, oai',
    size: 280,
    images: []
  },
  {
    id: 'grp_love_cute',
    name: 'DỄ THƯƠNG & THẢ TIM',
    keywords: 'love, hearts, heart, cute, lovely, sweet, kiss, adorable, yêu, tim, thương, kisses, moa, cute, đáng yêu, dễ thương',
    size: 280,
    images: []
  },
  {
    id: 'grp_scared',
    name: 'SỢ HÃI & LO LẮNG',
    keywords: 'scared, afraid, fear, nervous, terrified, horror, panic, help, sợ, hãi, ghê, khiếp, lo, cuống, thần hồn',
    size: 280,
    images: []
  },
  {
    id: 'grp_disappointed',
    name: 'BẤT LỰC & CHÁN NẢN',
    keywords: 'disappointed, hopeless, tired, exhausted, bored, sigh, facepalm, fail, bad, nản, chán, bất lực, vứt, dẹp, mệt, yếu',
    size: 280,
    images: []
  },
  {
    id: 'grp_thinking',
    name: 'SUY NGHĨ & NGHI NGỜ',
    keywords: 'think, thinking, wonder, suspect, logic, question, ask, why, what, nghĩ, suy nghĩ, nghi, sao, tại sao, thế nào',
    size: 280,
    images: []
  },
  {
    id: 'grp_cool_success',
    name: 'NGẦU / THÀNH CÔNG',
    keywords: 'cool, win, winner, success, rich, gold, champion, top, yes, wow, ngầu, thắng, xịn, đỉnh, vip, pro, chất',
    size: 280,
    images: []
  },
  {
    id: 'grp_sleepy',
    name: 'NGỦ & LƯỜI BIẾNG',
    keywords: 'sleep, sleepy, tired, lazy, yawn, night, dream, ngủ, khò, lười, oải, ngáp, đêm, mơ',
    size: 280,
    images: []
  }
];
