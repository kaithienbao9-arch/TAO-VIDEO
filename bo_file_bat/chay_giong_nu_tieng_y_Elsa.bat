...
cd /d "%~dp0"
cd ..
title Microsoft Edge-TTS - Elsa (it-IT) - V-Sync Engine
cls
echo =======================================================================
echo    AUTOMATIC MICROSOFT EDGE-TTS (VOICE: Elsa - it-IT Ý Nữ)
...
echo [*] Dang khoi dong giong doc AI: Elsa (it-IT-ElsaNeural)...
python run_edge_tts.py it-IT-ElsaNeural
