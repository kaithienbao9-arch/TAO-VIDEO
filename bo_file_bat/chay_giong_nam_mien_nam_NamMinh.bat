...
cls
echo =======================================================================
echo    AUTOMATIC MICROSOFT EDGE-TTS (VOICE: Nam Minh - vi-VN Miền Nam Nam)
...
echo [*] Dang khoi dong giong doc AI: Nam Minh (vi-VN-NamMinhNeural)...
python run_edge_tts.py vi-VN-NamMinhNeural
