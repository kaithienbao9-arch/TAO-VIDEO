...
cd /d "%~dp0"
cd ..
title Microsoft Edge-TTS - Guy (en-US) - V-Sync Engine
cls
echo =======================================================================
echo    AUTOMATIC MICROSOFT EDGE-TTS (VOICE: Guy - en-US Mỹ Nam)
...
echo [*] Dang khoi dong giong doc AI: Guy (en-US-GuyNeural)...
python run_edge_tts.py en-US-GuyNeural
