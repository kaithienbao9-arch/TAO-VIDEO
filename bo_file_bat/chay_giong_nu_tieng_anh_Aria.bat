...
cd /d "%~dp0"
cd ..
title Microsoft Edge-TTS - Aria (en-US) - V-Sync Engine
cls
echo =======================================================================
echo    AUTOMATIC MICROSOFT EDGE-TTS (VOICE: Aria - en-US Mỹ Nữ)
...
echo [*] Dang khoi dong giong doc AI: Aria (en-US-AriaNeural)...
python run_edge_tts.py en-US-AriaNeural
